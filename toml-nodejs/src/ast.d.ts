...
export type ValueNode = StringNode | IntegerNode | FloatNode | BooleanNode | OffsetDateTimeNode | LocalDateTimeNode | LocalDateNode | LocalTimeNode | ArrayNode | InlineTableNode;
...
export type Node = RootTableNode | KeyNode | KeyValuePairNode | TableNode | ArrayTableNode | InlineTableNode | ArrayNode | BareNode | StringNode | IntegerNode | FloatNode | BooleanNode | OffsetDateTimeNode | LocalDateTimeNode | LocalDateNode | LocalTimeNode;
