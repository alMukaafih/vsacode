declare namespace AceApi {
    export namespace Ace {
        ...
        export class MarkerGroup {
            constructor(
                session: EditSession,
                options?: { markerType?: "fullLine" | "line" }
            );
        ...
        export interface Editor extends OptionsProvider, EventEmitter {
            ...
            on(name: "select-word", callback: () => void): void;
    ...
    export const define: RequireDefine;
}

declare var ace: typeof AceApi;
