...
declare namespace AcodeApi {
     ...
     */
    function fileBrowser(mode: BrowseMode, info: string, doesOpenLast: boolean, defaultDir?: {
        name: string,
        url: string
     ...
     */
    function inputHints($input: HTMLInputElement, hints: string[], onSelect: (value: string) => void): void
    /**
     * Creates an HTMLElement
     * @param name
     * @param attributes
     */
    function tag<K extends keyof HTMLElementTagNameMap>(name: K, attributes: Record<string, string>): HTMLElementTagNameMap[K]
}
